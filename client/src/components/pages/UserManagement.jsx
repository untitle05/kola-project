...
class UserManagement extends Component {
  ...
  getTableData = (props) => props.state.userManagement.users.filter((user) => user.name.includes(props.state.searchStore.text)).map((user) => (
    <Table.Row>
      <Table.Cell>
        {user.name
            + (user.password
  ...
  selectUserForEditing = (id) => {
    const user = this.props.state.userManagement.users.find((v) => v.id === id);
